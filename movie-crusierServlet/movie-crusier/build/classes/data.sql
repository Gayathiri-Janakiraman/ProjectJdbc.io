...
SELECT * FROM movie_crusier.movie_list;

INSERT INTO `movie_crusier`.`movie_list` (`mov_id`, `mov_title`, `mov_gross`, `mov_active`, `mov_date_of_launch`, `mov_genre`, `mov_has_teaser`) VALUES ('1', 'Avatar', '2787965087', 'Yes', '2017-03-15', 'Science Ficiton', 'Yes');
INSERT INTO `movie_crusier`.`movie_list` (`mov_id`, `mov_title`, `mov_gross`, `mov_active`, `mov_date_of_launch`, `mov_genre`, `mov_has_teaser`) VALUES ('2', 'The Avengers', '1518812988', 'Yes', '2017-12-23', 'Superhero', 'No');
...
SELECT * FROM movie_crusier.user;
